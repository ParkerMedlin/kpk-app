<<<<<<< HEAD
SET "PGPASSWORD=blend2021"&& "C:\Program Files\PostgreSQL\15\bin\psql.exe" -h localhost -p 5432 -U postgres -d blendversedb -f "%USERPROFILE%\Desktop\core_deskoneschedule_dump.sql"
=======
