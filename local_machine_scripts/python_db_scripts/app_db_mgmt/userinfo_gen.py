...
data = [
    ...
    {'username' : 'kharper', 'email' : '', 'password' : 'kelly12345', 'first_name' : 'Kelly', 'last_name' : 'Harper'},
    {'username' : 'dtidwell', 'email' : '', 'password' : 'devin12345', 'first_name' : 'Devin', 'last_name' : 'Tidwell'},
    {'username' : 'lreyes', 'email' : '', 'password' : 'luckie12345', 'first_name' : 'Luckie', 'last_name' : 'Reyes'},
    {'username' : 'rreyes', 'email' : '', 'password' : 'ronald12345', 'first_name' : 'Ronald', 'last_name' : 'Reyes'}
]

with open('C:/Users/pmedlin/Desktop/output.csv', 'w', newline='') as csvfile:
    fieldnames = ['username', 'email', 'password', 'first_name', 'last_name']
