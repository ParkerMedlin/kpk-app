...
def get_horix_line_blends():
    ...
    sheetDFnewIndex.to_csv('init_db_imports\hxblnd.csv', header=True, index=False) #write to the csv in our folder
    ...
    with open('init_db_imports\hxblnd.csv', 'r', encoding='utf-8') as f:
