...
cursPG.execute("create table if not exists blending_procedures (id serial unique, item_code varchar(40) not null, status text, step_no int, step_desc text, component_code text, component_desc text)")
