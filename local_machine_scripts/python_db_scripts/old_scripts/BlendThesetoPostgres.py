...
sheetDataFrame.columns = sheetDataFrame.columns.str.replace('.','_')
sheetDataFrame.columns = sheetDataFrame.columns.str.replace(':','_')
sheetDataFrame.columns = sheetDataFrame.columns.str.replace('1','One')
sheetDataFrame.columns = sheetDataFrame.columns.str.replace('2','Two')
sheetDataFrame.columns = sheetDataFrame.columns.str.replace('3','Three')
os.remove(tempPath)
