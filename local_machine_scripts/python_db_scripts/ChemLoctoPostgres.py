...
def GetChemLocations():
    ...
    sheetDF.to_csv('init_db_imports\chemloc.csv', header=True, index=False) #write to the csv in our folder
    ...
    with open('init_db_imports\chemloc.csv', 'r', encoding='utf-8') as f:
