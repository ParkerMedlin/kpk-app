# Generated by Django 3.2.16 on 2022-11-28 16:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('run_date', models.DateTimeField(verbose_name='run_date')),
                ('run_day', models.TextField(blank=True, null=True)),
                ('date_entered', models.DateTimeField(verbose_name='when_entered')),
                ('qty_on_hand', models.DecimalField(blank=True, decimal_places=2, max_digits=100, null=True)),
            ],
            options={
