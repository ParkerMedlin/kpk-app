# Generated by Django 3.2.25 on 2026-01-21 19:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='flushtotereading',
            name='lab_technician',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='flush_totes_lab', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='flushtotereading',
            name='line_personnel',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='flush_totes_line', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name='flushtotereading',
            index=models.Index(fields=['production_line'], name='core_flush__product_a876d2_idx'),
        ),
        migrations.AddIndex(
            model_name='flushtotereading',
            index=models.Index(fields=['approval_status'], name='core_flush__approva_67a801_idx'),
        ),
        migrations.AddConstraint(
            model_name='flushtotereading',
            constraint=models.CheckConstraint(check=models.Q(('final_pH__isnull', True), models.Q(('final_pH__gte', Decimal('5.10')), ('final_pH__lte', Decimal('10.90'))), _connector='OR'), name='flush_tote_final_ph_range'),
        ),
    ]
