# Generated by Django 3.2.19 on 2023-08-16 19:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('component_item_code', models.TextField(blank=True, null=True)),
                ('component_item_description', models.TextField(blank=True, null=True)),
                ('run_component_qty', models.DecimalField(blank=True, decimal_places=5, max_digits=50, null=True)),
                ('component_on_hand_qty', models.DecimalField(blank=True, decimal_places=5, max_digits=50, null=True)),
                ('start_time', models.DecimalField(blank=True, decimal_places=7, max_digits=50, null=True)),
                ('prod_line', models.TextField(blank=True, null=True)),
                ('procurement_type', models.TextField(blank=True, null=True)),
                ('component_onhand_after_run', models.DecimalField(blank=True, decimal_places=5, max_digits=50, null=True)),
                ...
                ('nonstandard_total', models.DecimalField(blank=True, decimal_places=7, max_digits=50, null=True)),
