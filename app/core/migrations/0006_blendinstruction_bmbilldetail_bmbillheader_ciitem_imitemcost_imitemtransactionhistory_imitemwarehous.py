# Generated by Django 3.2.13 on 2022-05-02 17:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0005_alter_lotnumrecord_quantity'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantityperbill', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('standardunitcost', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('scrappercent', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maximumlotsize', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('yieldpercent', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('standardunitcost', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('standardunitprice', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('commissionrate', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('basecommamt', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('purchaseumconvfctr', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('salesumconvfctr', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('volume', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('restockingcharge', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ...
                ('itemimagewidthinpixels', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('itemimageheightinpixels', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('lasttotalunitcost', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('averageunitcost', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('salespromotionprice', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('suggestedretailprice', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('salespromotiondiscountpercent', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('totalquantityonhand', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('averagebackorderfilldays', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('lastallocatedunitcost', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('totalinventoryvalue', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ...
                ('numberuntilexpiration', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('calculatesellbybasedon', models.TextField(blank=True, null=True)),
                ('numbertosellbybefore', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('numbertosellbyafter', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('calculateusebybasedon', models.TextField(blank=True, null=True)),
                ('numbertousebybefore', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('numbertousebyafter', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('calculatereturnsbasedon', models.TextField(blank=True, null=True)),
                ('numbertoreturnafter', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
            ],
            options={
                'db_table': 'ci_item',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unitcost', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('quantityonhand', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('quantitycommitted', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('allocatedcost', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ...
                ('extendedcost', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('costcalcqtycommitted', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('costcalccostcommitted', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('datecreated', models.DateField(blank=True, null=True)),
                ('timecreated', models.TextField(blank=True, null=True)),
                ('usercreatedkey', models.TextField(blank=True, null=True)),
                ('dateupdated', models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transactionqty', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('unitcost', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('allocatedcost', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('unitprice', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('extendedprice', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('extendedcost', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('extendedstandardcost', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('dateupdated', models.DateField(blank=True, null=True)),
                ('timeupdated', models.TextField(blank=True, null=True)),
                ('userupdatedkey', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantityonhand', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('quantityonpurchaseorder', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('quantityonsalesorder', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('quantityonbackorder', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('averagecost', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('quantityrequiredforwo', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('economicorderqty', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('reorderpointqty', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('minimumorderqty', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('maximumonhandqty', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('quantityonworkorder', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('quantityinshipping', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('totalwarehousevalue', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('costcalcqtycommitted', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('costcalccostcommitted', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('datecreated', models.DateField(blank=True, null=True)),
                ('timecreated', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantityordered', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('quantityreceived', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('quantitybackordered', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('masteroriginalqty', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('masterqtybalance', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('masterqtyorderedtodate', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('quantityinvoiced', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('unitcost', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('originalunitcost', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('extensionamt', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ...
                ('unitofmeasureconvfactor', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('receivedallocatedamt', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
                ('invoicedallocatedamt', models.DecimalField(blank=True, decimal_places=65535, max_digits=65535, null=True)),
