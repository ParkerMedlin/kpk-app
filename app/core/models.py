...
class PoPurchaseorderdetail(models.Model):
    ...
    quantityordered = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    quantityreceived = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    quantitybackordered = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    masteroriginalqty = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    masterqtybalance = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    masterqtyorderedtodate = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    quantityinvoiced = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    unitcost = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    originalunitcost = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    extensionamt = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    ...
    unitofmeasureconvfactor = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    receivedallocatedamt = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    invoicedallocatedamt = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class ImItemwarehouse(models.Model):
    ...
    quantityonhand = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    quantityonpurchaseorder = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    quantityonsalesorder = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    quantityonbackorder = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    averagecost = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    quantityrequiredforwo = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    economicorderqty = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    reorderpointqty = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    minimumorderqty = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    maximumonhandqty = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    quantityonworkorder = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    quantityinshipping = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    totalwarehousevalue = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    costcalcqtycommitted = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    costcalccostcommitted = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class ImItemtransactionhistory(models.Model):
    ...
    transactionqty = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    unitcost = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    allocatedcost = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    unitprice = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    extendedprice = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    extendedcost = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    extendedstandardcost = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    dateupdated = models.DateField(blank=True, null=True)
    timeupdated = models.TextField(blank=True, null=True)
    userupdatedkey = models.TextField(blank=True, null=True)
...
class ImItemcost(models.Model):
    ...
    unitcost = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    quantityonhand = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    quantitycommitted = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    allocatedcost = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    transactiondate = models.DateField(blank=True, null=True)
...
class CiItem(models.Model):
    ...
    standardunitcost = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    standardunitprice = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    commissionrate = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    basecommamt = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    purchaseumconvfctr = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    salesumconvfctr = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    volume = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    restockingcharge = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    ...
    itemimagewidthinpixels = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    itemimageheightinpixels = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    lasttotalunitcost = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    averageunitcost = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    salespromotionprice = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    suggestedretailprice = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    salespromotiondiscountpercent = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    totalquantityonhand = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    averagebackorderfilldays = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    lastallocatedunitcost = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    totalinventoryvalue = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    ...
    numberuntilexpiration = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    calculatesellbybasedon = models.TextField(blank=True, null=True)
    numbertosellbybefore = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    numbertosellbyafter = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    calculateusebybasedon = models.TextField(blank=True, null=True)
    numbertousebybefore = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    numbertousebyafter = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    calculatereturnsbasedon = models.TextField(blank=True, null=True)
    numbertoreturnafter = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class BmBillheader(models.Model):
    ...
    maximumlotsize = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    yieldpercent = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class BmBilldetail(models.Model):
    ...
    setupcharge = models.TextField(blank=True, null=True)
    unitofmeasure = models.TextField(blank=True, null=True)
    quantityperbill = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    standardunitcost = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    scrappercent = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    workticketstepno = models.TextField(blank=True, null=True)
