...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        ...
        User.objects.create_user('sabdus', email='user3@kpkapp.biz', password='EpBlnd22KPK', first_name='Saeed', last_name='Abdus-Salaam')
        User.objects.create_user('mphillips', email='user4@kpkapp.biz', password='EpBlnd22KPK', first_name='Marquett', last_name='Phillips')
        User.objects.create_user('tjones', email='user5@kpkapp.biz', password='EpBlnd22KPK', first_name='Torrie', last_name='Jones')
        User.objects.create_user('gwingfield', email='user6@kpkapp.biz', password='EpBlnd22KPK', first_name='Grady', last_name='Wingfield')
        User.objects.create_user('jcalhounjr', email='user7@kpkapp.biz', password='EpBlnd22KPK', first_name='Joe', last_name='Calhoun_Jr')
