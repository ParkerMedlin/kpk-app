...
urlpatterns = [
    ...
    path('uncounted-items/', web.display_uncounted_items, name='uncounted_items'),
    ...
    path('production-value-forecast/', web.display_production_value_forecast_report, name='production-value-forecast'),
    ...
    path('discharge-testing/', web.discharge_testing_entry_view, name='discharge-testing-entry'),
    ...
    path('api/production-value-forecast/', api.get_json_production_value_forecast, name='production-value-forecast'),
    path('api/cost-impact-analysis/', api.get_json_cost_impact_analysis, name='cost-impact-analysis'),
    path('api/cost-workbook-data/', api.get_json_cost_workbook_data, name='cost-workbook-data'),
    path('api/bom-data/', api.get_json_bom_data, name='bom-data'),
