...
urlpatterns = [
    ...
    path('display-blend-run-order', web.display_blend_run_order, name='display-blend-run-order'),
    ...
    path('create-report/<which_report>', reports_services.create_report, name='reports'),
