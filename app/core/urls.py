...
urlpatterns = [
    ...
    path('api/purchasing-alias-audit/', api.update_purchasing_alias_audit, name='purchasing-alias-audit-api'),
    path('api/purchasing-alias/<int:alias_id>/', api.update_purchasing_alias, name='update-purchasing-alias'),
    path('api/purchasing-alias/create/', api.create_purchasing_alias, name='create-purchasing-alias'),
    path('api/purchasing-alias/<int:alias_id>/delete/', api.delete_purchasing_alias, name='delete-purchasing-alias'),
