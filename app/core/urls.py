...
urlpatterns = [
    ...
    path('getmaximumblendcapabilitynumbers/<this_component_item_code>/<this_item_code>', views.get_json_maximum_blend_capacity, name='get-json-maximum-blend-capacity'),
