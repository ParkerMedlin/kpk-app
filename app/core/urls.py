...
urlpatterns = [
    ...
    path('add-foam-factor/', views.add_lot_num_record, name='add-foam-factor'),
    path('update-foam-factor/<lot_num_id>', views.update_lot_num_record, name='update-foam-factor'),
    path('delete-foam-factor/', views.delete_lot_num_records, name='delete-foam-factor'),
