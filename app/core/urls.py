...
urlpatterns = [
    ...
    path('itemcode_request/', views.get_json_itemcode, name='get-item-code'),
    path('itemcodedesc_request/', views.get_json_item_description, name='get-item-desc'),
    ...
    path('countlist/display/<encoded_list>', views.display_count_list, name='display-count-list'),
    path('displayfinishedcounts/<encoded_list>', views.display_count_report, name='display-finished-counts'),
    path('delete_countrecord/<redirect_page>/<encoded_list>', views.delete_count_record, name='delete-count-record'),
    ...
    path('chemloc_request_desc/', views.get_json_chemloc_from_itemdesc, name='get-chem-location-from-desc'),
