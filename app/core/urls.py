...
urlpatterns = [
    ...
    path('get-blend-sheet-template/<encoded_item_code>/', views.get_json_blend_sheet_template, name='get-blend-sheet-template'),
    ...
    path('display-all-chemical-locations', views.display_all_item_locations, name='display-all-chemical-locations'),
