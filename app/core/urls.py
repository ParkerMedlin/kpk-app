...
urlpatterns = [
    ...
    path('check-automated-count-exists/', views.check_automated_count_exists, name='check-automated-count-exists'),
    ...
    path('get-json-item-location/<int:item_location_id>/', views.get_json_item_location_details, name='get-json-item-location-details'),
    path('update-item-location/<int:item_location_id>/', views.update_item_location, name='update-item-location'),
    path('add-missing-item-locations/', views.add_missing_item_locations, name='add-missing-item-locations'),
    ...
    path('get-current-user-initials/', views.get_json_current_user_initials, name='get-current-user-initials'),
    ...
    path('display-blend-tote-label/', views.display_blend_tote_label, name='display-blend-id-label'),
    ...
    path('get-json-container-label-data/', views.get_json_container_label_data, name='get-json-container-label-data'),
    path('get-json-all-container-labels-data/', views.get_json_all_container_labels_data, name='get-json-all-container-labels-data'),
