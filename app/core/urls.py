...
urlpatterns = [
    ...
    path('addlotnumrecord/<redirect_page>', views.add_lot_num_record, name='add-lot-num-record'),
    ...
    path('blendschedule/', views.display_blend_schedule, name='blend-schedule'),
    ...
    path('getmaximumblendcapabilitynumbers/<encoded_component_item_code>/<encoded_item_code>', views.get_json_maximum_blend_capacity, name='get-json-maximum-blend-capacity'),
