...
- [x] **1.1** Add `is_hidden` field to CountCollectionLink (USER ACTION: run migration)
...
- [x] **1.2** Update `get_count_status_rows` SQL to include hidden-collection flag
...
- [x] **2.1** Replace delete with hide in consumer
...
- [x] **2.2** Add restore action to consumer
  - **Do**: In `app/core/consumers.py`:
...
- [x] **2.3** Update WebSocket JS client
...
- [x] **3.1** Filter active collection links to exclude hidden
...
- [x] **3.2** Add hidden collection links view
...
- [x] **3.3** Pass `is_hidden` into count list view context
...
- [x] **3.4** Add URL routes and clean up old delete route
...
- [x] **3.5** Remove `delete_count_collection_links` service function
...
- [x] **4.1** Update collection links template for hide action
...
- [x] **4.2** Update collection links JS for hide action
...
- [x] **5.1** Add archived banner to count list template
...
- [x] **5.2** Add read-only mode to count list template
...
- [x] **5.3** Replace deletion modal with banner in count list JS
...
- [x] **6.1** Create hidden collections template
...
- [x] **6.2** Create hidden collections JS page module
